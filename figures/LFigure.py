...
class LFigure:
    ...
    def draw_figure(x, y, game_field, position):
        ...
        if position == 1:
            ...
            game_field[i][j] = 6
            game_field[i][j + 1] = 6
            game_field[i - 1][j + 2] = 6
            game_field[i][j + 2] = 6
        elif position == 2:
            Rectangle.draw_rectangle_orange(x + 30, y)
            Rectangle.draw_rectangle_orange(x + 30, y - 30)
            Rectangle.draw_rectangle_orange(x + 30, y - 60)
            Rectangle.draw_rectangle_orange(x, y - 60)
            game_field[i][j + 1] = 6
            game_field[i - 1][j + 1] = 6
            game_field[i - 2][j + 1] = 6
            game_field[i - 2][j] = 6
        elif position == 3:
            Rectangle.draw_rectangle_orange(x, y)
            Rectangle.draw_rectangle_orange(x, y - 30)
            Rectangle.draw_rectangle_orange(x + 30, y - 30)
            Rectangle.draw_rectangle_orange(x + 60, y - 30)
            game_field[i][j] = 6
            game_field[i - 1][j] = 6
    ...
    def can_turn(x, y, game_field, position):
        ...
        j = int(x / 30)
        if position == 1:
            if i > 2 and game_field[i - 1][j + 1] == 0 and game_field[i - 2][j + 1] == 0 and game_field[i - 2][j] == 0:
                position = 2
        elif position == 2:
            if j < 9 and game_field[i][j] == 0 and game_field[i - 1][j] == 0 and game_field[i - 1][j + 2] == 0:
                position = 3
        elif position == 3:
            if i > 3 and game_field[i][j + 1] == 0 and game_field[i - 2][j] == 0:
                position = 4
        elif position == 4:
            if j < 9 and game_field[i][j + 2] == 0 and game_field[i - 1][j + 2] == 0:
                position = 1
        return position
